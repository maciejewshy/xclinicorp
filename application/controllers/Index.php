...
class Index extends CI_Controller
{
    ...
    function login()
    {
        ...
        if ($login) {
            ...
            $this->session->unset_userdata('id_usuario', $_SESSION['id_usuario']);
            $this->session->unset_userdata('user', $_SESSION['usuario']);
            $this->session->unset_userdata('id_cliente', $_SESSION['id_cliente']);
            $this->session->unset_userdata('cliente', $_SESSION['cliente']);
