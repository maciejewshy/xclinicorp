...
<head>
    <meta charset="utf-8">
    <title>Política de Privacidade - HealthZap</title>
    ...
    <div class="container mt-5 mb-5">
        <div class="card shadow">
            <div class="card-body p-5">
                ...
                <p><span style="color: rgb(68, 68, 68);">A sua privacidade é importante para nós. É política do HealtZap
                        respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a
                            href="https://healthzap.top/">HealtZap</a>, e outros sites que possuímos e operamos.</span>
                </p>
                ...
                <p><span style="color: rgb(68, 68, 68);">O usuário se compromete a fazer uso adequado dos conteúdos e da
                        informação que o HealtZap oferece no site e com caráter enunciativo, mas não limitativo:</span>
                </p>
                <ul>
                    ...
                    <li><span style="color: rgb(68, 68, 68);">B) Não difundir propaganda ou conteúdo de natureza
                            racista, xenofóbica, jogos de sorte ou azar, qualquer tipo de pornografia ilegal, de
                    ...
                    <li><span style="color: rgb(68, 68, 68);">C) Não causar danos aos sistemas físicos (hardwares) e
                            lógicos (softwares) do HealtZap, de seus fornecedores ou terceiros, para introduzir ou
                ...
                <p><span style="color: rgb(68, 68, 68);">Esperemos que esteja esclarecido e, como mencionado
                        ...
                        site.</span></p>
                <p><span style="color: rgb(68, 68, 68);">Esta política é efetiva a partir de&nbsp;20 March 2026
                        14:22</span></p>
            </div>
        </div>
