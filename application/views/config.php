                    ...
                    <div class="col">
                        ...
                        <div id="clothingnavcontent1" class="tab-content">
                            <div role="tabpanel" class="tab-pane fade show active p-5 border " id="home1"
                                ...
                                <table class="table table-striped col-12 table-border-responsive" class="dataTable">
                                    ...
                                    <tbody class="">
                                        ...
                                        foreach ($canais as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td scope="row" >
                                                   <?php echo $con['conect'][$value->idFila] == false ? '<a href="'.base_url().'config/gerarQrcode?id_Canal='.$value->id_canal.'" class="qrcod"><i class="fa fa-qrcode" style="font-size:xx-large; color:red" ></i></a>' : '<i class="fa fa-qrcode" style="font-size:xx-large; color:green" ></i>' ;?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            <div role="tabpanel" class="tab-pane fade  p-5 border " id="paneTwo1"
                                ...
                                <table class="table table-striped table-inverse table " class="dtSetor">
                                    <thead class="thead-inverse">
                                        <tr>
                                            <th>Setor</th>
                                            <th>Ação</th>
                            ...
                            <div role="tabpanel" class="tab-pane fade p-5 border " id="paneTwo2"
                                ...
                                <table class="table table-striped table-inverse table-responsive " class="dataTable">
                                    <thead class="thead-inverse">
                                        <tr>
                                            <th>Canal</th>
                                            <th>Mensagem</th>
...
<!-- Modal -->
<div class="modal fade" id="gerardorQRcod" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
